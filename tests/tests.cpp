...
TEST_CASE("AnimeGraph::dfsSearch Tests", "") {
  ...
  a.makeGraph("../tests/data/test_anime.csv", "../tests/data/test_rating.csv");
  std::unordered_map<unsigned, Edge*> default_edges;
  Node* test1 = new Node{0, "Cowboy Bebop", std::vector<std::string>(), 0, 0, 0, default_edges};
  ...
  Node* test2 = new Node{0, "", std::vector<std::string> {"Action", "Adventure", "Comedy"}, 25, 9.00, 486000, default_edges};
